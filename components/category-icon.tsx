...
export function categoryMarkerSvg(category: Category, color = "#fff") {
  return `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="${color}" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">${svgPaths[category]}</svg>`;
}
